...
(274, 31, 0, '91811-download.jpeg', 'Robusta Green bean', '', '50000.00', 'pcs', '45000.00'),
(275, 32, 0, '039f1-petani-menunjukkan-buah-katak-porang-amorphophallus-muelleri-di-desa_210217121408-212.jpeg', 'Porang', '', '90000.00', 'kg', '0.00');
...
--
ALTER TABLE `data_produk`
  MODIFY `produk_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=276;
